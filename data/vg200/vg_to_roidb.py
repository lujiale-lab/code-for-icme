...
from data.vg200.utils.tools import cleaneddb2vg, db2vg
...
def main(args):
    ...
    _, cleaned_vgidx2dbidx = cleaneddb2vg()
    _, vgidx2dbidx = db2vg()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--json_file', default=NEW_VG_SGG_DICT)
    parser.add_argument('--h5_file', default=NEW_VG_SGG_FILE)
