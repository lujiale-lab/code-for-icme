...
def encode_objects(obj_data, token_counter, org_h, org_w, im_long_sizes):
...
def main(args):
    ...
    # encode object
    encode_objects(obj_data, object_token_counter, heights, widths, img_long_sizes)
    ...
    with open(osp.join(DATA_DIR, 'cleanse_objects.json'), 'w') as f:
        json.dump(obj_data, f)

    with open(osp.join(DATA_DIR, 'cleanse_relationships.json'), 'w') as f:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--object_list', default='/home/wangwenbin/Method/scene_graph/scene-graph-TF-release/data_tools/VG/object_list.txt', type=str)
    parser.add_argument('--pred_list', default='/home/wangwenbin/Method/scene_graph/scene-graph-TF-release/data_tools/VG/predicate_list.txt', type=str)
