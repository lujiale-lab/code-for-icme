#include <THC/THC.h>
#include <math.h>
#include "cuda/co_nms_kernel.h"

extern THCState *state;

int co_nms_apply(THIntTensor* keep, THCudaTensor* boxes_sorted, const float nms_thresh)
{
    ...
    int numTotalKeep = ApplyCONMSGPU(keep_data, boxes_sorted_data, boxes_num, nms_thresh, devId);
    return numTotalKeep;
}