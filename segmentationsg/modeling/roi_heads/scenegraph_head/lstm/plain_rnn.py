...
class PlainRNN(torch.nn.Module):
    def __init__(self, input_dim, hidden_dim, recurrent_dropout_probability=0.2,
    ...
    def rnn_forward(self,  # pylint: disable=arguments-differ
        ...
        return torch.cat(out_dists, 0)

    def forward(self, sal_inps, obj_boxes, union_boxes, im_centers):
        ...
        out_scores = self.rnn_forward(input_packed)
